...
public class CustomVideoCapturer extends BaseVideoCapturer implements
    ...
    public CustomVideoCapturer(Context context, Publisher.CameraCaptureResolution resolution,
        ...
        this.cameraIndex = getCameraIndexUsingFront( false );
    ...
    // Called for turning on flash on button click
    public void turnOnFlash() {
        ...
        // Do nothing when flash button clicked in front camera mode
    ...
    // Called for turning off flash on button click
    ...
    public int getSwapCameraStatus() {
